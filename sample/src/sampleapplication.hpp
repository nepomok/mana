...
protected:
    void start() override {
        ...
        std::vector<Compositor::Layer> layers = {
                ...
                {"PhongShading",   PhongShadePass::COMBINED, GeometryPass::DEPTH, DEPTH_TEST_ALWAYS},
                ...
                {"Depth",          GeometryPass::DEPTH,      "",                  DEPTH_TEST_ALWAYS},
                {"Position",       GeometryPass::POSITION,   "",                  DEPTH_TEST_ALWAYS},
                {"Normal",         GeometryPass::NORMAL,     "",                  DEPTH_TEST_ALWAYS},
