...
TextureBuffer *QtOGLTextureBuffer::upload(const Image<ColorRGB> &buffer) {
...
TextureBuffer *QtOGLTextureBuffer::upload(const Image<ColorRGBA> &buffer) {
    setTextureType(TextureBuffer::TEXTURE_2D);
...
TextureBuffer *QtOGLTextureBuffer::upload(const Image<float> &buffer) {
    setTextureType(TextureBuffer::TEXTURE_2D);
...
TextureBuffer *QtOGLTextureBuffer::upload(const Image<int> &buffer) {
    setTextureType(TextureBuffer::TEXTURE_2D);
...
TextureBuffer *QtOGLTextureBuffer::upload(const Image<char> &buffer) {
    setTextureType(TextureBuffer::TEXTURE_2D);
...
TextureBuffer *QtOGLTextureBuffer::upload(const Image<unsigned char> &buffer) {
    setTextureType(TextureBuffer::TEXTURE_2D);
...
TextureBuffer *QtOGLTextureBuffer::upload(CubeMapFace face, const Image<ColorRGBA> &buffer) {
...
TextureBuffer *QtOGLTextureBuffer::uploadCubeMap(const Image<ColorRGBA> &buffer) {
