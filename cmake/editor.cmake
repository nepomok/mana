...
set(HDR_GUI_MANA_EDITOR editor/src/qt/mainwindow.hpp)
...
if (WIN32)
    ...
    add_executable(mana-editor-qt ${EDITOR_SRC_QT} ${WRAP_CPP} ${WRAP_UI})
endif ()

target_include_directories(mana-editor-qt PUBLIC ${DIR_EDITOR_INCLUDE} ${DIR_EDITOR_SRC})
